...
public class PasswordlessActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void sendSignInLink(String email) {
        ActionCodeSettings settings = ActionCodeSettings.newBuilder()
                ...
                .setUrl("https://andrewvu.page.link/emailSignInLink")
                .build();
        //https://andrewvu.page.link/emailSignInLink
        //https://auth.example.com/emailSignInLink
        //https://androidfirebase-a2b94.firebaseapp.com
